...
```{r q1_p1_graph}
ggplot(data = q1_p1_data, aes(x = year, y = value, fill = type)) +
  geom_bar(position = "dodge", stat = "identity") + facet_wrap(~brand_type)
  labs(title = "Prevelance of Different Types of Ads Over Time", x = "Year", y = "Count") + transition_reveal(year)
```
